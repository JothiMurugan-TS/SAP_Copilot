...
5. Send a message to Copilot to find a SAP record.
...
| `src`        | The source code for the SAP API                                                          |

The following files can be customized and demonstrate an example implementation to get you started.

| File                                         | Contents                                                                                          |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `src/functions/products.ts`                   | The main file of a function in Azure Functions.                                                   |
| `appPackage/apiSpecificationFile/products.yml` | A file that describes the structure and behavior of the SAP API.                               |
...
| `appPackage/sapDeclarativeAgent.json` | Define the behaviour and configurations of the declarative agent. |
